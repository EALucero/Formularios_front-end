window.addEventListener('load', () => {
    ...
    $form.addEventListener('submit', (e) => {     
        ...
        if (rating.value <= 0 || rating.value > 10.0) {
            ...
            rating.classList.toggle('is-valid');
        ...
        if (awards.value <= 0 || awards.value > 10) {
            ...
            awards.classList.toggle('is-valid');
        ...
        if (release_date.value == "") {
            ...
            release_date.classList.toggle('is-valid');
        ...
        if (length.value < 60 || length.value > 360) {
            ...
            length.classList.toggle('is-valid');
        ...
        if (genre_id.value == '') {
            ...
            genre_id.classList.toggle('is-invalid');
        } else {
            genre_id.classList.toggle('is-valid');
            genre_id.classList.remove('is-invalid');
        };

        if (errors.length > 0) {
            e.preventDefault(); // no anda esto, revisar
